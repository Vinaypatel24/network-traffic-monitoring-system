...
-- Uses GENERATED BY DEFAULT AS IDENTITY instead of BIGSERIAL
-- Removes PostgreSQL partial-index syntax (WHERE clause on index)
-- ============================================================
...
-- NOTE: H2 does not support partial unique indexes (WHERE clause).
-- One-active-session-per-user is enforced at the service layer.
...
CREATE INDEX idx_blacklisted_ip_active ON blacklisted_ips(ip_address);
